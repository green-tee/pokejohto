...
extern const u8 gText_WhatIsThisPlace[];
extern const u8 gText_ImLookingForAFriend[];
extern const u8 gText_NothingImGood[];
...
extern const u8 gText_RegionMap_AreaDesc_IlexForest[];
...
extern const u8 gText_QuestLog_IlexForest[];
