...
const u32 gTrainerFrontPic_LeaderJoey[] = INCBIN_U32("graphics/trainers/front_pics/leader_joey_front_pic.4bpp.lz");
const u32 gTrainerPalette_LeaderJoey[] = INCBIN_U32("graphics/trainers/palettes/leader_joey.gbapal.lz");
...
const u8 gTrainerBackPic_LeaderJoey[] = INCBIN_U8("graphics/trainers/back_pics/leader_joey_back_pic.4bpp");
...
const u32 gTrainerPalette_LeaderJoeyBackPic[] = INCBIN_U32("graphics/trainers/palettes/leader_joey_back_pic.gbapal.lz");
