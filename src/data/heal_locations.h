...
{
    [SPAWN_PALLET_TOWN - 1] = {MAP_GROUP(PALLET_TOWN), MAP_NUM(PALLET_TOWN), 7, 21},
    [SPAWN_VIRIDIAN_CITY - 1] = {MAP_GROUP(VIRIDIAN_CITY), MAP_NUM(VIRIDIAN_CITY), 26, 27},
    [SPAWN_PEWTER_CITY - 1] = {MAP_GROUP(PEWTER_CITY), MAP_NUM(PEWTER_CITY), 53, 46},
    [SPAWN_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_TOWN), MAP_NUM(AZALEA_TOWN), 26, 14},
    [SPAWN_LAVENDER_TOWN - 1] = {MAP_GROUP(LAVENDER_TOWN), MAP_NUM(LAVENDER_TOWN), 52, 7},
    ...
    [SPAWN_ROUTE4 - 1] = {MAP_GROUP(ROUTE4), MAP_NUM(ROUTE4), 20, 123},
    ...
    [SPAWN_SANDALINE_COLONY - 1] = {MAP_GROUP(SANDALINE_COLONY), MAP_NUM(SANDALINE_COLONY), 18, 20},
...
static const u16 sWhiteoutRespawnHealCenterMapIdxs[][2] =
{
    ...
    [SPAWN_AZALEA_TOWN - 1] = {MAP_GROUP(AZALEA_TOWN_POKEMON_CENTER), MAP_NUM(AZALEA_TOWN_POKEMON_CENTER)},
    ...
    [SPAWN_SANDALINE_COLONY - 1] = {MAP_GROUP(SANDALINE_COLONY_POKEMON_CENTER), MAP_NUM(SANDALINE_COLONY_POKEMON_CENTER)},
