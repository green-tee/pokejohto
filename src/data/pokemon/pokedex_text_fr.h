...
const u8 gParasectPokedexText[] = _(
    ...
    "mushroom cap. In some regions, the spores\n"
...
const u8 gArcaninePokedexText[] = _(
    "A Pokémon that is described in foreign\n"
...
const u8 gPoliwrathPokedexText[] = _(
    ...
    "crawl, Beautifly, and more. It is faster\n"
...
const u8 gGastlyPokedexText[] = _(
    ...
    "topple a careless Donphan by enveloping\n"
...
const u8 gMewPokedexText[] = _(
    "A Pokémon from another continent that was\n"
...
const u8 gXatuPokedexText[] = _(
    "In some cultures, it is said that its right\n"
