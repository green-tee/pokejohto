...
{
    u16 spriteId = CreateMonPicSprite_HandleDeoxys(species, FALSE, 0x8000, TRUE, x, y, 0, gMonPaletteTable[species].tag);
...
{
    const struct CompressedSpritePalette * spritePalette = GetMonSpritePalStructFromSpecies(species, isShiny);
    u16 spriteId = CreateMonPicSprite_HandleDeoxys(species, isShiny, personality, 1, x, y, 0, spritePalette->tag);
