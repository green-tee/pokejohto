...
static const u8 *const sLocationNameTexts[] =
    {
        ...
        [QL_LOCATION_ILEX_FOREST_1]      = gText_QuestLog_IlexForest,
        [QL_LOCATION_ILEX_FOREST_2]      = gText_QuestLog_IlexForest,
...
static const u8 sLocationToDepartedTextId[] =
    {
        ...
        [QL_LOCATION_ILEX_FOREST_1]      = QL_DEPARTED_CAVE,
        [QL_LOCATION_ILEX_FOREST_2]      = QL_DEPARTED_CAVE,
...
static const u16 sQuestLogWorldMapFlags[] =
    {
        ...
        FLAG_WORLD_MAP_SANDALINE_COLONY,
