...
static const u8 sMapFlyDestinations[][3] = {
    ...
    [MAPSEC_SANDALINE_COLONY    - MAPSECS_KANTO] = {MAP(SANDALINE_COLONY),                      SPAWN_SANDALINE_COLONY},
...
static u8 GetMapsecType(u8 mapsec)
{
    ...
    case MAPSEC_SANDALINE_COLONY:
        return FlagGet(FLAG_WORLD_MAP_SANDALINE_COLONY) ? MAPSECTYPE_VISITED : MAPSECTYPE_NOT_VISITED;
