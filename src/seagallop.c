...
static const s8 sSeag[][4] = {
    ...
    [SEAGALLOP_SANDALINE_COLONY] = {MAP(FOUR_ISLAND_HARBOR),  0x08, 0x05},
...
static const u16 sTravelDirectionMatrix[] = {
    ...
    [SEAGALLOP_SANDALINE_COLONY] = 0x6e0, // 11011100000
...
u8 GetSeagallopNumber(void)
{
    ...
    if ((originId == SEAGALLOP_SANDALINE_COLONY 
      || originId == SEAGALLOP_FIVE_ISLAND) 
      && (destId == SEAGALLOP_SANDALINE_COLONY 
