...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[105] = {
    ...
    {FACILITY_CLASS_LEADER_BRAWLY,          TRAINER_ENCOUNTER_MUSIC_BOY},
    ...
    {FACILITY_CLASS_CAMPER,                 TRAINER_ENCOUNTER_MUSIC_BOY},
    {FACILITY_CLASS_CYCLING_TRIATHLETE_F,   TRAINER_ENCOUNTER_MUSIC_BOY},
    ...
    {FACILITY_CLASS_LEADER_ROXANNE,         TRAINER_ENCOUNTER_MUSIC_BOY},
...
static const u16 sTrainerTowerEncounterMusic[] = {
    ...
    [TRAINER_ENCOUNTER_MUSIC_INTENSE]     = MUS_ENCOUNTER_YOUNGSTER,
    [TRAINER_ENCOUNTER_MUSIC_COOL]        = MUS_ENCOUNTER_YOUNGSTER,
    [TRAINER_ENCOUNTER_MUSIC_AQUA]        = MUS_ENCOUNTER_ROCKET,
    [TRAINER_ENCOUNTER_MUSIC_MAGMA]       = MUS_ENCOUNTER_ROCKET,
    [TRAINER_ENCOUNTER_MUSIC_SWIMMER]     = MUS_ENCOUNTER_YOUNGSTER,
    [TRAINER_ENCOUNTER_MUSIC_BOY]         = MUS_ENCOUNTER_YOUNGSTER,
    [TRAINER_ENCOUNTER_MUSIC_ELITE_FOUR]  = MUS_ENCOUNTER_YOUNGSTER,
    [TRAINER_ENCOUNTER_MUSIC_HIKER]       = MUS_ENCOUNTER_YOUNGSTER,
    [TRAINER_ENCOUNTER_MUSIC_INTERVIEWER] = MUS_ENCOUNTER_YOUNGSTER,
    [TRAINER_ENCOUNTER_MUSIC_RICH]        = MUS_ENCOUNTER_YOUNGSTER
};
